...
function Home() {
  return (
    <div id="home">
      ...
      <div className="wrapper">
        <div>
        <p id="intro">例えば、青でもなく空色でもなく「白藍
          しらあい」という、日本の伝統色の名前が知りたいとき使えます。 画像を選んでも、ネット上で送られるのは一番使われている色のRGB値だけ。画像自体はどこにも送られません。
          現時点ではPC・Macのみ対応していますが、スマホ対応も鋭意進行中です。<br/><br/>
